...
%Al igual que en el caso de las señales de voltaje, los valores de las
%gráficas para ciertos puntos son los valores máximos que la señal de
%corriente instantánea tendrá para ese punto. 
